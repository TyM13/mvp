...
# runs the statment CALL get_comments and sends the upload_id as an arguement and stores the select statmentment from the procedure as results 
...
# runs the statment CALL post_comment and sends the content, upload_id and token as an arguement and stores the select statmentment from the procedure as results 
...
# runs the statment CALL patch_comments and sends the content, upload_id and token as an arguement and stores the select statmentment from the procedure as results 
...
# runs the statment CALL delete_comments and sends the upload_id and token as an arguement and stores the select statmentment from the procedure as results 
